...
void setup() {
  ...
  //tasma.setMinPulseWidth(20);
  //tasma.setMaxSpeed(4400); // 4 steps - 4400 max 250 acc
  //tasma.setMaxSpeed(8200); // 8 steps - 8200 max 500 acc
  //tasma.setMaxSpeed(13000); // 16 steps - 13000 bez max 500 acc (zaczyna lagowac serial!)
  tasma.setMaxSpeed(5000); //
  tasma.setAcceleration(1000);

  tasma.moveTo(tasma.currentPosition()+4000000);  

  tasma2.setMaxSpeed(5000); //
  tasma2.setAcceleration(1000);

  tasma2.moveTo(tasma.currentPosition()+4000000);  
  //


  Serial.println("Koniec inicjacji programu");
  ...
  if (Serial.available() > 0)
    {
        ...
        if (Bajt == 43){
          ...
          tasma.setMaxSpeed(tasma.speed() + 1000);
        }
        else if (Bajt == 45 )
        {
          //tasma.moveTo(tasma.currentPosition()-40000);
        ...
        {
          Serial.print(BT1.get_units());
          Serial.print(BT2.get_units());
          Serial.print(BT3.get_units());
          Serial.print(BT4.get_units());
        }
